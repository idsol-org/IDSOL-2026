...
(function () {
    ...
    <nav id="main-nav">
        <a href="index.html" class="nav-logo">
            <img src="https://cdn.kb.institute/eto-2026/IDSOL/Logo/Square_Dark_Background_2026_500.png" alt="IDSOL Logo">
            <span class="nav-logo-text">IDSOL 2026</span>
        </a>
        <ul class="nav-links">
            <li>
